package com.TemanSebangkuApp.ts_app.kasir.adapter;
...
public class adpt_status_menu extends RecyclerView.Adapter<com.TemanSebangkuApp.ts_app.kasir.adapter.adpt_status_menu.ViewHolder> {
    ...
    @Override
    public com.TemanSebangkuApp.ts_app.kasir.adapter.adpt_status_menu.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.template_status_menu, parent, false);
        com.TemanSebangkuApp.ts_app.kasir.adapter.adpt_status_menu.ViewHolder vh = new com.TemanSebangkuApp.ts_app.kasir.adapter.adpt_status_menu.ViewHolder(v);
        return vh;
    }

    @SuppressLint("ResourceAsColor")
    @Override
    public void onBindViewHolder(com.TemanSebangkuApp.ts_app.kasir.adapter.adpt_status_menu.ViewHolder holder, int position) {
