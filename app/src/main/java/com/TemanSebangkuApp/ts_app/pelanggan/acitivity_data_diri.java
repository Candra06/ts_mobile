...
import static com.TemanSebangkuApp.ts_app.R.id.txt_tgl_lahir;
...
public class acitivity_data_diri extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_tgl_lahir = (EditText) findViewById(R.id.txt_tgl_lahir_edit);
        ...
        imgback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(acitivity_data_diri.this, activity_profil.class);
                acitivity_data_diri.this.startActivity(intent);
                acitivity_data_diri.this.finish();
            }
        });
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (data.getString("status").equals("1")) {
                        ...
                        val_tgl_lahir = data.getString("tgl_lahir");
                        val_gender = data.getString("gender");
                ...
                public void onResponse(String response) {
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            pd.dismiss();
                            Toast.makeText(acitivity_data_diri.this, ""+ error.getMessage(), Toast.LENGTH_LONG).show();
                            Log.e("Erronya edit", error.getMessage(), error);
                            Log.e("Erronya edit", error.getMessage()+SharedPrefManager.getInstance(acitivity_data_diri.this).getAuthKey(), error);
                        }
                    }
            ) {
                @Override
